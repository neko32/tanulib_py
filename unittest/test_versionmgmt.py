...
class VersionMgmtTest(TestCase):
    ...
    def test_semver_comparison(self):
        ...
        self.assertEqual(left.compare(right_smaller_by_major), ComparisonResult.LEFT_BIGGER)
        self.assertEqual(left.compare(right_smaller_by_minor), ComparisonResult.LEFT_BIGGER)
        self.assertEqual(left.compare(right_smaller_by_patch), ComparisonResult.LEFT_BIGGER)
        self.assertEqual(left.compare(right_tie), ComparisonResult.BOTH_EQUAL)
        self.assertEqual(left.compare(right_bigger_by_major), ComparisonResult.LEFT_SMALLER)
        self.assertEqual(left.compare(right_bigger_by_minor), ComparisonResult.LEFT_SMALLER)
        self.assertEqual(left.compare(right_bigger_by_patch), ComparisonResult.LEFT_SMALLER)
