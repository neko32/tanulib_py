...
from tlib.ml.feature import (
    build_resnet152_for_feature_extaction,
...
def main():
    ...
    m = build_resnet152_for_feature_extaction()
    m.summary()
    ...
    rez, sim_scores = fsearch.search_by_cos_similarty(features[search_id], pick_top_n = 9)
